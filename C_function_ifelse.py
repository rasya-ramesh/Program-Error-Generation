...
def p_selectionStmt(t):
	'''selectionStmt : IF LPAREN simpleexpression RPAREN LFPAREN statement RFPAREN ELSE LFPAREN statement RFPAREN
					 | IF LPAREN simpleexpression RPAREN LFPAREN statement RFPAREN 
