...
def t_DOT(t):
	...
	t.value = Node('DOT', t.value, leaf = 1)
	return t

def t_PTR_OP(t):
	r'\->'
	t.type=reserved.get(t.value,'PTR_OP')
	t.value = Node('PTR_OP', t.value, leaf = 1)
	return t
...
data = open('../programs/c/data_structures/input_programs/complex_struct.c',"r").read()
...
fname = 'complex_struct.c'.split(".")[0]
extension = 'complex_struct.c'.split(".")[1]
n_add_errors = 1
n_remove_errors = 3
n_replace_errors = 1
