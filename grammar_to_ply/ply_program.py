...
data = open('../programs/python/data_structures/input_programs/binary_tree_size.py',"r").read()
...
pgms =  5
directory= '../programs/python/data_structures/output_programs/'
#directory = "../programs/python/functions/output_programs/"
#directory2 = "../programs/python/functions/output_programs/errors"

fname = 'binary_tree_size.py'.split(".")[0]
extension = 'binary_tree_size.py'.split(".")[1]
n_add_errors = 1
n_remove_errors = 3
n_replace_errors = 1
