...
data = open('programs/c/teacher_programs/input_programs/check_odd.c',"r").read()
...
pgms =  5
directory= 'programs/c/teacher_programs/output_programs/'

fname = 'check_odd.c'.split(".")[0]
extension = 'check_odd.c'.split(".")[1]
